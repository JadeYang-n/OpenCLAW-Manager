...
/// 部署进度（包含日志流）（已废弃）
#[derive(Serialize, Deserialize, Debug, Clone)]
#[deprecated(since = "2.0.0", note = "请使用JobProgressReplica")]
#[allow(dead_code)]
...
/// 检查 WSL2 是否安装（已废弃）
#[deprecated(since = "2.0.0", note = "请使用check_wsl2_installed_replica")]
fn _check_wsl2_installed() -> bool {
    Command::new("wsl")
        .arg("--list")
        .arg("--verbose")
        .output()
...
/// 获取 WSL 版本（已废弃）
#[deprecated(since = "2.0.0", note = "请使用get_wsl_version_replica")]
fn _get_wsl_version() -> Option<String> {
    Command::new("wsl")
        .arg("--version")
        .output()
        .ok()
...
/// 检查 Ubuntu 是否安装（已废弃）
#[deprecated(since = "2.0.0", note = "请使用check_ubuntu_installed_replica")]
fn _check_ubuntu_installed() -> bool {
    Command::new("wsl")
        .arg("--list")
        .arg("--verbose")
        .output()
